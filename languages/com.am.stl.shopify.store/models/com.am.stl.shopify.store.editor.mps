...
<model ref="r:ecbcdbb3-4039-435a-bac5-51ee7f5df8af(com.am.stl.shopify.store.editor)">
  ...
  <imports>
    <import index="aamx" ref="r:6077155f-e74a-4f51-864e-0cf04b7041a7(com.am.stl.shopify.store.structure)" implicit="true" />
